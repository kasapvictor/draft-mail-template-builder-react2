...
import { changedValue} from "../models/model-mock-data5";
    ...
    <>
      ...
      <div style={{height: '100%', wordSpacing: 'normal', backgroundColor: '#f8f9fc'}} className="wrapper">
        <div style={{margin: '0px auto', maxWidth: width}} className="wapper__table">
          <Table maxWidth={600}>
            <Tr>
              {/*<Td>{renderElements(mockData)}</Td>*/}
            </Tr>
            <Tr>
              <Td>
                <Column>
                  {/*<Element tag={mockData[0].tag} content={mockData[0].content} {...mockData[0].attributes} onClick={(event)=>changedActiveIndexElement({event, path: '0', id:mockData[0].id})}/>*/}
                </Column>
              </Td>
            </Tr>
            <Tr>
